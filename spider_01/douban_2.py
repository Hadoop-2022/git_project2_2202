    ...
    for i in range(0,226,25):
        ...
        for item in items:
            ...
            with connection.cursor() as cursor:
                        # Create a new record
                sql = "INSERT INTO `douban_requests` (`movie_poster`,`movie_name`,`Chinese_name`,`English_name`,`Hongkong_Taiwan`,`Detailed_explanation`,`Score`,`Number_evaluators`,`Quote`) VALUES (%s,%s,%s,%s,%s,%s,%s,%s,%s)"
